#!/usr/bin/env python3
"""
Build script to create Windows executable from video_merger.py
...
def main():
    ...
    print("=" * 60)
    print("Video Merger - Executable Builder")
    print("=" * 60)
    ...
    # PyInstaller command
    script_path = os.path.join(os.path.dirname(__file__), "video_merger.py")
    ...
    pyinstaller_args = [
        ...
        "--hidden-import", "tqdm",
        # Collect all moviepy data files
        "--collect-all", "moviepy",
    ...
    try:
        ...
        print("\nNote: Make sure FFmpeg is accessible on the target system.")
        print("      The executable bundles imageio-ffmpeg which includes FFmpeg.")
